...
// Páginas
// ----------------------------------------------------------------------
$paginas = ['bases', 'tablas', 'crear_tabla', 'estructura', 'datos', 'fila', 'sql', 'auditoria', 'usuarios'];
if (!in_array($pagina, $paginas, true)) {
    $pagina = 'bases';
}
if (in_array($pagina, ['tablas', 'crear_tabla', 'estructura', 'datos', 'fila', 'sql'], true) && $base === '') {
