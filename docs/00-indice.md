...
php tests/f4_api.php          → OK: 44    peticiones reales contra la API
php tests/f5_esquema.php      → OK: 54    SHOW, ALTER y restricciones
php tests/f5_admin.php        → OK: 97    el panel, navegado como un usuario
```
