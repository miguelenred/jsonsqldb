...
Versión **1.7.0** — ver [CHANGELOG.md](../CHANGELOG.md).
...
```
php tests/f1_nucleo.php       → OK: 56    almacenamiento, tipos, bloqueos
php tests/f2_parser.php       → OK: 67    analizador y parámetros ligados
php tests/f2_select.php       → OK: 78    ejecución de SELECT y orden alfabético
